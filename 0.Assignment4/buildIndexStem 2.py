...
class buildIndexStem:
	...
	def write_to_file(self, target):
		with open('stemindex.pickle', 'wb') as handle:
			pickle.dump(target, handle)
		with open('snippet.pickle', 'wb') as handle:
			pickle.dump(self.ssnippet, handle)
...
if __name__ == "__main__":
	temp = buildIndexStem("bookkeeping.json")
	temp.read_json()
